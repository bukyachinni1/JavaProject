...
public class LabourDetails {
	...
	private String labourFatherName;
	private String labourAddress;
	private String labourSal;
	...
	public String getLabourFatherName() {
		return labourFatherName;
	}

	public void setLabourFatherName(String labourFatherName) {
		this.labourFatherName = labourFatherName;
	}
	...
	public String getLabourSal() {
		return labourSal;
	}

	public void setLabourSal(String labourSal) {
